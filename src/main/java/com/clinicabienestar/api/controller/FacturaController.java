...
public class FacturaController {
    ...
    /**
     * Envía un correo electrónico con el resumen de la factura al email del paciente.
     * Requiere que el paciente tenga un email registrado (via su Usuario).
     */
    @PostMapping("/{id}/enviar-correo")
    @PreAuthorize("hasAuthority('GESTIONAR_FACTURACION')")
    public ResponseEntity<Map<String, String>> enviarFacturaPorCorreo(@PathVariable Long id) {
        String mensaje = facturaService.enviarFacturaPorCorreo(id);
