...
public class HistoriaClinicaController {
    ...
    @PostMapping("/consultas/{consultaId}/recetas")
    @PreAuthorize("hasAuthority('EDITAR_HISTORIAL_CLINICO')")
    public ResponseEntity<Receta> agregarReceta(@PathVariable Long consultaId, @RequestBody com.clinicabienestar.api.dto.RecetaDTO recetaDTO) {
        Receta recetaGuardada = historiaClinicaService.agregarReceta(consultaId, recetaDTO);
