...
public class CitaController {
    ...
    @PreAuthorize("hasAnyRole('ENFERMERA', 'ADMINISTRADOR')")
    public ResponseEntity<Cita> registrarTriaje(@PathVariable Long id, @Valid @RequestBody com.clinicabienestar.api.dto.TriajeDTO triajeDTO) {
        return ResponseEntity.ok(citaService.registrarTriaje(id, triajeDTO));
    }
}