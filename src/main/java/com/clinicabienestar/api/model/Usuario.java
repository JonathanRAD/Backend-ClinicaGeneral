...
public class Usuario implements UserDetails {
    ...
    /** Código OTP de 6 dígitos para verificación 2FA en el registro */
    @Column(name = "OTP_CODE")
    private String otpCode;

    /** Fecha/hora de expiración del OTP (10 minutos por defecto) */
    @Column(name = "OTP_EXPIRY")
    private LocalDateTime otpExpiry;

    /** Indica si el email del usuario ya fue verificado via OTP */
